...
CGMZ.Versions["Quest System"] = "Alpha R4";
CGMZ.QuestSystem = {};
...
CGMZ.QuestSystem.RecLvlNegativeColors = CGMZ_Utils.parseJSON(CGMZ.QuestSystem.parameters["Rec Level Negative Colors"], [], "CGMZ Quest System", "Your Rec Level Negative Colors parameter is set up incorrectly and could not be read.");
CGMZ.QuestSystem.RecLvlPositiveColors = CGMZ_Utils.parseJSON(CGMZ.QuestSystem.parameters["Rec Level Positive Colors"], [], "CGMZ Quest System", "Your Rec Level Positive Colors parameter is set up incorrectly and could not be read.");
...
CGMZ.QuestSystem.EmptyQuestBoardText = CGMZ_Utils.parseJSON(CGMZ.QuestSystem.parameters["Empty Quest Board Text"], "Error", "CGMZ Quest System", "Your Empty Quest Board Text parameter is set up incorrectly and could not be read.");
...
CGMZ_QuestData.prototype.initialize = function(quest) {
	...
	this._unstartedObjective = CGMZ_Utils.parseJSON(quest["Unstarted Objective"], "Error - See Dev Tools Console", "CGMZ Quest System", `Your unstarted objective parameter for quest ${this._name} was set up incorrectly and could not be read`);
	this._unstartedDescription = CGMZ_Utils.parseJSON(quest["Unstarted Description"], "Error - See Dev Tools Console", "CGMZ Quest System", `Your unstarted description parameter for quest ${this._name} was set up incorrectly and could not be read`);
	this._boardDescription = CGMZ_Utils.parseJSON(quest["Board Description"], "Error - See Dev Tools Console", "CGMZ Quest System", `Your board description parameter for quest ${this._name} was set up incorrectly and could not be read`);
...
CGMZ_QuestData.prototype.setupObjectives = function(objectives) {
	...
	for(const jsonObj of objectives) {
		objective = CGMZ_Utils.parseJSON(jsonObj, null, "CGMZ Quest System", `An objective for quest ${this._name} was set up incorrectly and could not be read`);
...
CGMZ_QuestCategory.prototype.initialize = function(questCategory) {
	...
	this._description = CGMZ_Utils.parseJSON(questCategory.Description, "Error - See Dev Tools Console", "CGMZ Quest System", `The description parameter for category ${this._name} was set up incorrectly and could not be read`);
...
CGMZ_Window_QuestList.prototype.addPinnedCategory = function(pinnedQuests) {
	if(CGMZ.QuestSystem.PinnedCategory && (pinnedQuests.length > 0 || CGMZ.QuestSystem.AlwaysShowPinnedCategory)) {
...
CGMZ_Window_QuestList.prototype.addCompletedCategory = function(pinnedQuests) {
	...
	if(CGMZ.QuestSystem.CompleteCategory && (completedQuests.length > 0 || CGMZ.QuestSystem.AlwaysShowCompleteCategory)) {
...
CGMZ_Window_QuestList.prototype.addFailedCategory = function(pinnedQuests) {
	...
	if(CGMZ.QuestSystem.FailedCategory && (failedQuests.length > 0 || CGMZ.QuestSystem.AlwaysShowFailedCategory)) {
